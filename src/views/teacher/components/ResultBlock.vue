<template>
  <div class="result-block [margin-top:20px] [border:0.5px_solid_rgba(0,_0,_0,_0.06)] [border-radius:16px] [overflow:hidden] [background:#fff]">
    <div class="result-header [display:flex] [justify-content:space-between] [align-items:center] [padding:12px_20px] [background:#f9f9f9] [border-bottom:0.5px_solid_rgba(0,_0,_0,_0.06)] [margin-bottom:20px] [padding:16px] [border-radius:8px] [margin-bottom:10px] max-[640px]:[flex-direction:column] max-[640px]:[align-items:flex-start] max-[640px]:[gap:8px]">
