<template>
  <div class="result-block [margin-top:20px] [border:0.5px_solid_rgba(0,_0,_0,_0.06)] [border-radius:16px] [overflow:hidden] [background:#fff]">
    ...
    <el-input
      ...
      readonly
      :rows="12"
      class="raw-textarea [&_.el-textarea__inner]:[font-family:'Menlo',_'Consolas',_monospace] [&_.el-textarea__inner]:[font-size:12px] [&_.el-textarea__inner]:[background:#f9f9f9] [&_.el-textarea__inner]:[border:none] [&_.el-textarea__inner]:[border-radius:0]"
    />
